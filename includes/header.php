    ...
    <header id="header" class="header header-layout1">
      <div class="header__promo-text text-right mr-4">
       <span> <i class="fa fa-phone"></i>  (+91) 9671770772</span>
      </div><!-- /.header__promo-text -->
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container-fluid px-0">
          <a class="navbar-brand" href="index.php">
            <img src="assets/images/logo/jk-ind-logo.png" class="jk-ind-logo" alt="logo" style="width: 185px;">
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav__item with-dropdown">
                ...
                <i class="fa fa-angle-right" data-toggle="dropdown"></i>
                <ul class="dropdown-menu">
                  <li class="nav__item"><a href="news.php" class="nav__item-link">Our Blog</a></li>
                  <!-- /.nav-item -->
                  <li class="nav__item"><a href="news-single-post.php" class="nav__item-link">Single Blog Post</a></li>
                  <!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              ...
              <li class="nav__item">
                <a href="contacs.php" class="nav__item-link">Contact Us</a>
              </li><!-- /.nav-item -->
