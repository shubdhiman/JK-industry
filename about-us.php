...
<html lang="en">
  ...
  <body>
    ...
    =========================== -->
      <section
        id="pageTitle"
        class="page-title text-center bg-overlay bg-overlay-3 bg-parallax"
      >
        <div class="bg-img">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-9 offset-xl-1">
              <div class="heading heading-3 mb-50">
                <span class="heading__subtitle"
                  >Setting A Global Standard In Industrial Contracting.</span
                >
          ...
          <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-5">
              <div class="about__img mb-50">
                ...
                <div class="cta__banner">
                  ...
                  <h5 class="cta__title">
                    Latest Solutions, And <br />
                    Decades Of Experience.
                  </h5>
                  <a href="#" class="btn btn__white btn__link">
                    <i
                      class="icon-arrow-right arrow-rounded arrow-rounded-white"
                    ></i>
                  </a>
                </div>
                <!-- /.cta__banner -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-5">
              <div class="about__text mb-30">
                <p>
                  Axima is a representative Industrial Construction operator
                  providing full range of services and soultions in the sphere
              ...
              <div class="about__signature mb-30">
                <a href="#" class="btn btn__primary btn__bordered mr-40"
                  >More About Us</a
                >
                <img
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-12">
                  <div class="counter-item">
                    ...
                    <p class="counter__desc">
                      portfolio Completed In The Last 5 Years
                    </p>
                  </div>
                  <!-- /.counter-item -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <div class="video__btn text-center">
                ...
                >
                  ...
                  <span
                    class="video__player-animation video__player-animation-2"
                  ></span>
        ...
        <div class="container">
          <div class="row mb-50">
            <div class="col-sm-12 col-md-12 col-lg-7">
              <div class="heading">
                <span class="heading__subtitle"
                  >We Work With Global Industries!</span
                >
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              ...
              >
                <div class="portfolio-item">
                  ...
                  <div class="portfolio__content">
                    <h4 class="portfolio__title">
                      <a href="#">Floride Chemicals Factory</a>
                    </h4>
                ...
                <div class="portfolio-item">
                  ...
                  <div class="portfolio__content">
                    <h4 class="portfolio__title">
                      <a href="#">Highway Energy Station</a>
                    </h4>
                    <div class="portfolio__cat">
                ...
                <div class="portfolio-item">
                  ...
                  <div class="portfolio__content">
                    <h4 class="portfolio__title">
                      <a href="#">Villy Manufacturing Inc</a>
                    </h4>
                    <div class="portfolio__cat">
                ...
                <div class="portfolio-item">
                  <div class="portfolio__img">
                    <img
                      src="assets/images/case-studies/grid/5.jpg"
                      alt="portfolio img"
                    />
                    <a href="#" class="view__icon">View</a>
                  </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
              <div class="heading text-center mb-50">
                <span class="heading__subtitle"
                  >Latest Articles Updated Daily</span
                >
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="blog-item">
                ...
                <div class="blog__content">
                  ...
                  <h4 class="blog__title">
                    <a href="#"
                      >Importance of specialized focus in portfolio, Oil & Gas
                      Logistics?</a
                    >
                  </h4>
                  <a href="#" class="btn btn__secondary btn__link">
